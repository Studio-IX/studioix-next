...
const Pricing = () => {
  return (
    <section className=" w-full px-3">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 md:max-w-4xl gap-4 mx-auto mt-12">
        <div className="flex flex-col justify-between items-start p-6 w-full h-[32rem] bg-[#090909] border border-[#272727] rounded-3xl">
          <div>
            <h4 className=" font-archivo text-lg md:text-xl w-full text-primary uppercase">
              Design-Only
            </h4>
            <p className=" font-archivo text-base md:text-lg w-full text-white opacity-70 mt-2">
            ...
            <div className="flex flex-col gap-2 mt-6">
              <div className="flex items-center gap-1">
                ...
                <p className=" font-archivo text-base md:text-lg w-full text-white opacity-70">
          ...
          <div className=" w-full mt-4 md:mt-8 relative inline-flex h-12 overflow-hidden rounded-full p-[3px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 group">
        ...
        <div className="flex flex-col justify-between items-start p-6 w-full h-[32rem] bg-[#090909] border border-[#272727] rounded-3xl relative overflow-clip">
          <div className=" z-10">
            ...
            <p className=" font-archivo text-base md:text-lg w-full text-white mt-2 opacity-70">
